...
import e.user.netmodel.interceptor.AddCookiesInterceptor;
import e.user.netmodel.interceptor.CacheInterceptor;
import e.user.netmodel.interceptor.HeaderInterceptor;
import e.user.netmodel.interceptor.ReceivedCookiesInterceptor;
import e.user.netmodel.utils.SSLUtils;
...
public class GlobalRxHttp {
    ...
    private static class SingleHolder{
        private static final GlobalRxHttp INSTANCE = new GlobalRxHttp();
    }
}
